...
class Relationship(Intangible):
    subject: Optional[Union[Entity,Intangible,PhysicalEntity,PhysicalDevice,IndividualOrganism,Concept,InformationEntity,StructuredValue,Role,Relationship,EntitySet,OrganismalRelationship,Location,PointLocation,Specification,Procedure]] = Field(None)
    predicate: Optional[str] = Field(None)
    object: Optional[Union[Entity,Intangible,PhysicalEntity,PhysicalDevice,IndividualOrganism,Concept,InformationEntity,StructuredValue,Role,Relationship,EntitySet,OrganismalRelationship,Location,PointLocation,Specification,Procedure]] = Field(None)
...
class EntitySet(Intangible):
    ...
    """
    members: Optional[List[Union[Entity,Intangible,PhysicalEntity,PhysicalDevice,IndividualOrganism,Concept,InformationEntity,StructuredValue,Role,Relationship,EntitySet,OrganismalRelationship,Location,PointLocation,Specification,Procedure]]] = Field(default_factory=list, description="""The members of the collection""")
