...
linkml_meta = LinkMLMeta({'default_prefix': 'comet',
     ...
     'source_file': 'src/comet/schema//bio.yaml',
     'title': 'comet-bio'} )
...
class Dataset(InvestigativeEntity):
    ...
    observables: Optional[List[Union[Observable,Sample,EnvironmentalMaterial,Organism,OrganismPart,OrganismPopulation,Microbiome]]] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'observables', 'domain_of': ['Dataset']} })
