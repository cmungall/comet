...
linkml_meta = LinkMLMeta({'default_prefix': 'comet',
     'default_range': 'string',
     'description': 'Common Observational Model: Core',
     'id': 'https://w3id.org/comet/core',
     'imports': ['linkml:types', 'enums/data_absent_reason'],
     'license': 'MIT',
     'name': 'comet-core',
     'prefixes': {'BFO': {'prefix_prefix': 'BFO',
                  ...
                  '_base': {'prefix_prefix': '_base',
                            'prefix_reference': 'http://example.org/'},
                  'bibo': {'prefix_prefix': 'bibo',
                           'prefix_reference': 'http://purl.org/ontology/bibo/'},
                  'biolink': {'prefix_prefix': 'biolink',
                              'prefix_reference': 'https://w3id.org/biolink/'},
                  'comet': {'prefix_prefix': 'comet',
                            'prefix_reference': 'https://w3id.org/comet/'},
                  ...
                  'oboe-core': {'prefix_prefix': 'oboe-core',
                                'prefix_reference': 'http://ecoinformatics.org/oboe/oboe.1.0/oboe-core.owl#'},
                  'om': {'prefix_prefix': 'om',
                         'prefix_reference': 'http://www.opengis.net/om/2.0'},
     ...
     'see_also': ['https://linkml.github.io/comet'],
     'source_file': 'src/comet/schema//core.yaml',
     'title': 'comet-core',
     'types': {'CountScalar': {'from_schema': 'https://w3id.org/comet/core',
                               'minimum_value': 0,
                               'name': 'CountScalar',
                               'typeof': 'integer'}}} )
...
class Dataset(InvestigativeEntity):
    ...
    observables: Optional[List[Union[Observable,Sample]]] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'observables', 'domain_of': ['Dataset']} })
    ...
    events: Optional[List[Event]] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'events', 'domain_of': ['Dataset']} })
