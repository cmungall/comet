...
gen-datamodels: $(patsubst src/comet/schema/%.yaml, src/comet/datamodel/%.py, $(MODULE_YAMLS))
...
examples/output: src/comet/schema/comet.yaml
	mkdir -p $@
...
git-init:
	git init
git-add: .cruft.json
	git add .gitignore .github .cruft.json Makefile LICENSE *.md examples utils about.yaml mkdocs.yml poetry.lock project.Makefile pyproject.toml src/comet/schema/*yaml src/*/datamodel/*py src/data src/docs tests src/*/_version.py
